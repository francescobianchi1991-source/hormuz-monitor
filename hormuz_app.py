...
if "Mappa" in page:
    ...
    if comps:
        ...
        fig_comp.add_vline(x=70, line=dict(color="#ef4444", dash="dash", width=1),
                           ...
                           annotation_font_size=10)
        fig_comp.update_layout(**PLOTLY_DARK, height=280, title=dict(text=""), showlegend=False)
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    fig_hist.update_layout(**PLOTLY_DARK, height=420, title=dict(text=""))
    fig_hist.update_yaxes(range=[0, 105], title_text="Disruption Index")
